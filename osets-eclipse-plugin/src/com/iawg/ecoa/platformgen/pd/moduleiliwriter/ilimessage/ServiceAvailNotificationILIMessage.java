...
public class ServiceAvailNotificationILIMessage extends ILIMessage {
	private SM_ServiceInstance serviceInstance;

	public ServiceAvailNotificationILIMessage(int messageID, SM_ServiceInstance serviceInstance) {
		super(messageID);
