...
public class ServiceOpUIDWriterC extends SourceFileWriter {
	...
	public ServiceOpUIDWriterC(Path outputDir, SM_ProtectionDomain protectionDomain) {
		super(outputDir);
	...
	@Override
	public void open() {
		super.openFile(outputDir.resolve(pd.getName() + "_Service_Op_UID.h"));
	}
	...
	public void writePreamble() {
		String preambleText = "/* File " + pd.getName() + "_Service_Op_UID.h */" + LF;
