...
public class ModuleImplMakefileWriterAda extends ModuleImplMakefileWriter {
	private SM_ModuleImpl modImpl;
	private String containerOutputDirString;

	public ModuleImplMakefileWriterAda(Path outputDir, SM_ModuleImpl modImpl, Path containerOutputDir) {
		super(outputDir);
	...
	protected void setFileStructure() {
		...
		fileStructure = "#PREAMBLE#" + LF + LF + "OBJS=#OBJS#" + LF + "TARGET=#TARGET#" + LF + "CC=gcc $(CPPFLAGS)" + LF + "CFLAGS=-I" + containerOutputDirString + "/include" + LF + "AR=ar" + LF + LF + "default: $(TARGET)" + LF + LF + "clean:" + LF + "\trm -f obj/*.o" + LF + "\trm -f *.a" + LF + LF + "#OBJECTS#" + "dirCheck:" + LF + "\tmkdir -p obj" + LF + LF + "$(TARGET) : dirCheck $(OBJS)" + LF + "\t$(AR) -cr $@ $(OBJS)" + LF;
	...
	public void writeHeaders() {
		...
		headerText += modImpl.getName() + ".ads " + modImpl.getName() + "_user_context.ads " + modImpl.getName() + "_Container.ads";
	...
	public void writeObjects() {
		...
		objectText += "obj/" + modImpl.getName() + ".o : " + modImpl.getName() + ".adb " + modImpl.getName() + ".ads " + modImpl.getName() + "_Container.ads " + LF + "\t$(CC) $(CFLAGS) -c $< -o $@" + LF + LF;
	...
	public void writeSources() {
		...
		sourceText += modImpl.getName() + ".adb ";
