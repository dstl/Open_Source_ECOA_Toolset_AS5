...
public class CompDefReferencePage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public CompDefReferencePage() {
		super("Client Component");
		setTitle("New ECOA Client Component");
		setDescription("This wizard creates a new Client Component XML Definition");
	}
