...
public class EventServicePage extends WizardPage {
	...
	public EventServicePage() {
		super("Event Service");
		setTitle("New ECOA Event Service");
		setDescription("This wizard creates a new Event Service XML Definition");
	}
	...
	public void createControl(Composite parent) {
		...
		dirCombo = new Combo(root, SWT.NULL);
