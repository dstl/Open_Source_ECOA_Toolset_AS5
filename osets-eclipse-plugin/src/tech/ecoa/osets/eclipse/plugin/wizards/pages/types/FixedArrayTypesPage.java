...
public class FixedArrayTypesPage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public FixedArrayTypesPage() {
		super("Fixed Array Type");
		setTitle("New ECOA Fixed Array Type");
		setDescription("This wizard creates a new Fixed Array Type XML Definition");
	}
	...
	public FixedArray getFixedArray() {
