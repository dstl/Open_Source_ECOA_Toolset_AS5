...
public class ModuleOperationParameterFigure extends AbstractFigure {
	private Label display = new Label();
	private ModuleOperationParameterNode node;

	public ModuleOperationParameterFigure() {
		super();
	...
	public void rebuildFigure() {
		...
		setOpaque(true);
		setVisible(true);
		setForegroundColor(ModuleOperationParameterNode.FONT_COLOR);
		setBackgroundColor(ModuleOperationParameterNode.DEF_COLOR);
