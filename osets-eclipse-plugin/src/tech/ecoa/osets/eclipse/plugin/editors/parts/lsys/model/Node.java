...
public class Node extends Observable implements IAdaptable {
	...
	public void refreshAll(LogicalSystemNode node) {
		node.setChanged();
	...
	public LogicalSystemNode getRootNode() {
		if (this instanceof LogicalSystemNode)
			return (LogicalSystemNode) this;
		else if (this instanceof LogicalComputingPlatformNode)
			return (LogicalSystemNode) this.getParent();
		else if (this instanceof LogicalComputingNode)
			return (LogicalSystemNode) this.getParent().getParent();
		else if (this instanceof LogicalProcessorsNode)
			return (LogicalSystemNode) this.getParent().getParent().getParent();
		return null;
	}
