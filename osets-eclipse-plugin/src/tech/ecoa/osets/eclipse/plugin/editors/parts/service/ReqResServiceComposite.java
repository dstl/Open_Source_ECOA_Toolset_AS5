...
public class ReqResServiceComposite {
	...
	public void createPartControl(Composite parent) {
		...
		nameText.setText((reqRes.getName() != null) ? reqRes.getName() : "");
		nameText.setLayoutData(gd);
		label = new Label(ret, SWT.NULL);
		label.setText("&Comment:");
		commentText = new Text(ret, SWT.BORDER | SWT.SINGLE);
		commentText.setText((reqRes.getComment() != null) ? reqRes.getComment() : "");
		...
		label.setText("&Input:");
		label = new Label(ret, SWT.NULL);
		iTabValues = new TableViewer(ret, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.BORDER);
	...
	public RequestResponse getProcessedReqRes() {
	...
	public ArrayList<Parameter> getiParamArr() {
		if (iParamArr == null) {
			...
			iParamArr.addAll(reqRes.getInput());
		}
		return iParamArr;
	}
	...
	public ArrayList<Parameter> getuParamArr() {
		if (uParamArr == null) {
			...
			uParamArr.addAll(reqRes.getOutput());
		}
		return uParamArr;
	}
