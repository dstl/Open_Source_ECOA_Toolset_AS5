...
public class VarRecTypesComposite {
	...
	public void createPartControl(Composite parent) {
		...
		nameText.setText((vRec.getName() != null) ? vRec.getName() : "");
		label = new Label(ret, SWT.NULL);
		label.setText("&Select Name:");
		selNameText = new Text(ret, SWT.BORDER | SWT.SINGLE);
		selNameText.setLayoutData(gd);
		selNameText.setText((vRec.getSelectName() != null) ? vRec.getSelectName() : "");
		label = new Label(ret, SWT.NULL);
		label.setText("Select T&ype:");
		typeCombo = new Combo(ret, SWT.NULL);
		refreshTypes();
		typeCombo.setLayoutData(gd);
		typeCombo.setText((vRec.getSelectType() != null) ? vRec.getSelectType() : "");
		label = new Label(ret, SWT.NULL);
		label.setText("&Comment:");
		commentText = new Text(ret, SWT.BORDER | SWT.SINGLE);
		commentText.setLayoutData(gd);
		commentText.setText((vRec.getComment() != null) ? vRec.getComment() : "");
		label = new Label(ret, SWT.NULL);
		label.setText("&Values:");
		fTabValues = new TableViewer(ret, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.BORDER);
		...
		label = new Label(ret, SWT.NULL);
		label.setText("");
		Composite iValComp = new Composite(ret, SWT.NULL);
		...
		uTabValues = new TableViewer(ret, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.BORDER);
		...
		label = new Label(ret, SWT.NULL);
		label.setText("");
		Composite uValComp = new Composite(ret, SWT.NULL);
		valLayout.numColumns = 3;
		valLayout.verticalSpacing = 9;
		valLayout.horizontalSpacing = 9;
	...
	public VariantRecord getvRec() {
		return vRec;
	}

	public VariantRecord getProcessedVarRec() {
	...
	public void setvRec(VariantRecord vRec) {
		this.vRec = vRec;
	}
