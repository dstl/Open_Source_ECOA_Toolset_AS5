...
import tech.ecoa.osets.eclipse.plugin.editors.parts.assmbl.edpart.CompositeEditPart;
import tech.ecoa.osets.eclipse.plugin.editors.parts.assmbl.edpart.EditPartFactory;
import tech.ecoa.osets.eclipse.plugin.editors.parts.assmbl.model.ComponentNodeCreationFactory;
import tech.ecoa.osets.eclipse.plugin.editors.parts.assmbl.model.CompositeNode;
import tech.ecoa.osets.eclipse.plugin.editors.parts.assmbl.model.CompositePropertyNodeCreationFactory;
import tech.ecoa.osets.eclipse.plugin.editors.parts.assmbl.model.LinkCreationFactory;
import tech.ecoa.osets.eclipse.plugin.util.ParseUtil;

@SuppressWarnings("deprecation")
public class InitAssemblyEditor extends GraphicalEditorWithFlyoutPalette implements IResourceChangeListener {
	...
	private CompositeNode parse(String text) {
		return ParseUtil.getInitialAssemblyNodeFromText(text);
	}
